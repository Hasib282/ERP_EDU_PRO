            ...
            <table id="example1" class="table table-bordered table-striped dataTable dtr-inline collapsed"role="grid"
                ...
                <thead>
                    <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                            aria-label="Browser: activate to sort column ascending">Unit Status</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                    ...
                    @foreach ($inv_unit as $key => $item)
                        <tr class="odd">
                            ...
                            <td style="display: flex; gap:5px;">
                                <button class="btn btn-info btn-sm open-modal editUnitModal"
                                    data-modal-id="editUnitModal" data-id="{{ $item->id }}"><i
