        ...
        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline collapsed"role="grid"
            ...
            <thead>
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Supplier</th>
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Invoice</th>
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Product</th>
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Batch</th>
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">CP</th>
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Discount</th>
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Expiry Date</th>
            ...
            <tbody>
                @foreach ($inv_receive_details as $key => $item)
                    <tr class="odd">
                        <td class="dtr-control sorting_1" tabindex="0">{{ $inv_receive_details->firstItem() + $key }}</td>
                        ...
                        <td>
                            @if ($item->status == 1)
                                <a href="{{ route('status', ['table_name' => 'Inv_Receive_Detail', 'id' => $item->id, 'status' => $item->status]) }}"
                        ...
                        <td style="display: flex; gap:5px;">
                            <button class="btn btn-info btn-sm open-modal editReceiveDetailModal" data-modal-id="editReceiveDetailModal"
