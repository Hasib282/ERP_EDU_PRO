            ...
            <table id="example1"
                ...
                <thead>
                    <tr role="row">
                        <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1"
                            ...
                            aria-label="Rendering engine: activate to sort column descending">SL:</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                            colspan="1" aria-label="Browser: activate to sort column ascending">Manufacturer
                            Name</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                            colspan="1" aria-label="Browser: activate to sort column ascending">Manufacturer
                            Email</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                            ...
                            Contact</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                            colspan="1" aria-label="Browser: activate to sort column ascending">Inserted By
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                            colspan="1" aria-label="Browser: activate to sort column ascending">Status</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                ...
                <tbody>
                    @foreach ($inv_manufacturer as $key => $item)
                        <tr class="odd">
                            <td class="dtr-control sorting_1" tabindex="0">{{ $inv_manufacturer->firstItem() + $key }}</td>
                            ...
                            <td style="display: flex;gap:5px;">
                                <button class="btn btn-info btn-sm open-modal editManufacturerModal" data-modal-id="editManufacturerModal" data-id="{{ $item->id }}"><i class="fas fa-edit"></i>Edit</button>
                                <button class="btn btn-danger btn-sm deleteManufacturer" data-id="{{ $item->id }}" id="delete"><i class="fas fa-trash"></i>Delete</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
